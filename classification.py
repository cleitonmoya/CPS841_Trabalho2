...
# Time series model
T = 1                           # number of periods of time series
...
# WiSARD
addressSize = 24                 # number of bits for RAMs adressing
...
for n in range(N): 
    ...
    endTimeExp = time.time()
    expDuration = endTimeExp-startTimeExp
    #print("Experiment duaration: {0:4.2f}ms".format(expDuration*1000))
